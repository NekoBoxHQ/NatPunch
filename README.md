...
```shell
sh -c "$(wget -qO- https://raw.githubusercontent.com/internetdroid/NatPunch/master/install_server.sh)"
```
...
```shell
wget -qO- https://raw.githubusercontent.com/internetdroid/NatPunch/master/uninstall_client.sh | sh
```

OpenWrt：

```shell
uclient-fetch -qO- https://raw.githubusercontent.com/internetdroid/NatPunch/master/uninstall_client.sh | sh
```
