...
从 [releases](https://github.com/lima-droid/nps/releases) 下载对应系统版本，服务端 (`nps`) 和客户端 (`npc`) 是单独的压缩包。
...
镜像主页：[NPS](https://hub.docker.com/r/lima-droid/nps) ｜ [NPC](https://hub.docker.com/r/yisier1/npc)。
...
```shell
git clone https://github.com/lima-droid/nps.git
cd nps
